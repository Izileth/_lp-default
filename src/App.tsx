...
export default function App() {
  ...
  const isUtilityPage = ["Sobre nós", "Privacidade", "Termos de uso", "Contato"].includes(currentPage);
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      {(currentPage !== "Simuladores" && !isUtilityPage) && (
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div className="md:col-span-2">
              <span className="text-2xl font-black text-gray-900 cursor-pointer" style={{ fontFamily: "'Playfair Display',Georgia,serif" }} onClick={() => setCurrentPage("Simuladores")}>INVEST</span>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-500 font-medium">
                {["Sobre nós", "Privacidade", "Termos de uso", "Contato"].map(l => (
                  <li key={l}><button onClick={() => setCurrentPage(l)} className="hover:text-indigo-600 transition-colors">{l}</button></li>
                ))}
              </ul>
            </div>
          </div>
